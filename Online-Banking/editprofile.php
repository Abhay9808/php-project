...
" required=""/></td>
                ...
                <tr>
                    <td>gender</td>
                    <td>
                        M<input type="radio" name="gender" value="M" <?php 
if ($rws[2] == 'M') {
    echo 'checked';
}
?>
/>
                        F<input type="radio" name="gender" value="F" <?php 
if ($rws[2] == 'F') {
    echo 'checked';
}
?>
...
"/>
                ...
                <tr>
                    <td>Nominee</td>
                    <td><input type="text" name="nominee" value="<?php echo $rws[4];
?>
" required=""/></td>
                </tr>
                <tr>
...
>developer</option>
                ...
                <tr>
                    ...
                    <td>
                        <input type="date" name="doj" value="<?php 
echo $rws[8];
?>
"/>
                    </td>
